...
public class Evenement
{
    ...
    [DisplayName("Nombre de places total")] public int NbPlaces { get; set; } = default!;
    
    [DisplayName("Nombre de places réservé au membre")] public int NbPlacesMembre { get; set; } = default!;
