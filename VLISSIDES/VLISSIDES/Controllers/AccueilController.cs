...
public class AccueilController : Controller
{
    ...
    public IActionResult Index()
    {
        List<ServiceCardVM> services = new()
        {
            ...
            new ServiceCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/book-icon.png", "Programme Éco-responsable",
            ...
            new ServiceCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/book-icon.png", "Promotions et Offres spéciales  ",
        ...
        {
            new LivreCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/flat.png", "Ma vie avec l'équipe Vlissides", (decimal)6.66,
        ...
        {
            new LivreCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/flat.png", "Le chaperon rouge", (decimal)0.69,
                new Auteur { NomAuteur = "Grimms"},
                new Categorie { Nom = "Conte" }),
            new LivreCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/flat.png"), new LivreCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/flat.png"), new LivreCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/flat.png"),
            new LivreCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/flat.png")
        };
        ...
        List<LivreCardVM> livreCategories = new()
        {
            ...
            new LivreCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/jean-luc.png", "Coder avec Jean-Luc", (decimal)40.99,
                new Auteur{ NomAuteur = ""},
                new Categorie { Nom = "Informatique" }),
            new LivreCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/flat.png"),
            new LivreCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/flat.png"), new LivreCardVM("img/flat.png"),
            new LivreCardVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/flat.png")
        };
