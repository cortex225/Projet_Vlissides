...
public class AccueilController : Controller
{
    ...
    {
        List<CarteServiceVM> services = new()
        {
            new CarteServiceVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/book-icon.png", "Boutique en ligne ",
            ...
            new CarteServiceVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/event.png", "Événements et Activités",
            ...
            new CarteServiceVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/book-icon.png",
            ...
            new CarteServiceVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/book-icon.png",
                ...
                "fa-solid fa-tags"),
            new CarteServiceVM("https://sqlinfocg.cegepgranby.qc.ca/2147186/img/book-icon.png", "Espace Membre",
