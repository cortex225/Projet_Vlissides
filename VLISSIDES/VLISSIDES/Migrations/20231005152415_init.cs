    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0", "32580db4-fe50-4271-acb3-1ab25577f343", "Employe", "EMPLOYE" },
                    { "1", "f6ce6f6e-f38a-4f20-89c3-fbc5dce97c18", "Membre", "MEMBRE" },
                    { "2", "4620bdae-1f4f-48b1-9dc4-2181e69be021", "Admin", "ADMIN" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "AdressePrincipaleId", "ConcurrencyStamp", "DateNaissance", "Discriminator", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "Nom", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "Prenom", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "0", 0, null, "c5aef00a-7526-4223-b395-afc397862e02", null, "ApplicationUser", "admin@admin.com", true, false, null, "ADMIN", "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAEAACcQAAAAEP5A0+Sh49GqZJZev/DKqD7yieTvqVejrmGV0mV6PL5KNos4tLJnJL1tHceX7HezGA==", null, false, "Admin", "128b2f2d-a705-45cd-a373-968b5ccc6c1b", false, "admin@admin.com" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "AdressePrincipaleId", "ConcurrencyStamp", "DateNaissance", "Discriminator", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NoEmploye", "Nom", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "Prenom", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "1", 0, "", "5c349bde-d69e-49b4-a1ee-8015270c3dac", null, "Employe", "employe@employe.com", true, false, null, "007", "EMPLOYE", "EMPLOYE@EMPLOYE.COM", "EMPLOYE@EMPLOYE.COM", "AQAAAAEAACcQAAAAEP5A0+Sh49GqZJZev/DKqD7yieTvqVejrmGV0mV6PL5KNos4tLJnJL1tHceX7HezGA==", null, false, "Employe", "2afbb670-ed16-4e83-a7ce-e168908f0f48", false, "employe@employe.com" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "AdressePrincipaleId", "CommandeId", "ConcurrencyStamp", "DateAdhesion", "DateNaissance", "Discriminator", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NoMembre", "Nom", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "Prenom", "ReservationId", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "2", 0, "", null, "7f2d36c8-73ea-49a5-976b-a0155eacb011", new DateTime(2023, 10, 5, 11, 24, 10, 86, DateTimeKind.Local).AddTicks(1131), null, "Membre", "membre@membre.com", true, false, null, "123456", "MEMBRE", "MEMBRE@MEMBRE.COM", "MEMBRE@MEMBRE.COM", "AQAAAAEAACcQAAAAEP5A0+Sh49GqZJZev/DKqD7yieTvqVejrmGV0mV6PL5KNos4tLJnJL1tHceX7HezGA==", null, false, "Membre", null, "f2536d25-a9e1-4643-9cf6-b2afd7f588f9", false, "membre@membre.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "Excel 1", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2756), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001193", null, "Excel 1", 24, 96, "", "\"Le Petit Prince\"" },
                    { "Excel 10", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2801), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001202", null, "Excel 10", 32, 464, "", "\"La Nuit des temps\"" },
                    { "Excel 11", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2814), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001203", null, "Excel 11", 2, 256, "", "\"Le Guépard\"" },
                    { "Excel 12", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2817), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001204", null, "Excel 12", 13, 540, "", "\"Les Fourmis\"" },
                    { "Excel 13", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2821), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540102", null, "Excel 13", 62, 720, "", "\"Moby-Dick\"" },
                    { "Excel 14", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2824), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540103", null, "Excel 14", 2, 704, "", "\"Crime et Châtiment\"" },
                    { "Excel 15", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2827), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540104", null, "Excel 15", 2, 480, "", "\"Le Maître et Marguerite\"" },
                    { "Excel 16", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2830), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540105", null, "Excel 16", 14, 255, "", "\"Le Parfum\"" },
                    { "Excel 17", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2833), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540106", null, "Excel 17", 15, 288, "", "\"Le Lion\"" },
                    { "Excel 18", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2837), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540107", null, "Excel 18", 34, 123, "", "\"L'Étranger\"" },
                    { "Excel 19", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2841), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540108", null, "Excel 19", 6, 880, "", "\"Le Chardonneret\"" },
                    { "Excel 2", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2776), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001194", null, "Excel 2", 325, 320, "", "\"Harry Potter à l'école des sorciers\"" },
                    { "Excel 20", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2844), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540109", null, "Excel 20", 2, 384, "", "\"Le Journal d'Anne Frank\"" },
                    { "Excel 21", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2848), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540110", null, "Excel 21", 40, 144, "", "\"La Ferme des Animaux\"" },
                    { "Excel 22", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2851), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540111", null, "Excel 22", 31, 416, "", "\"L'Odyssée\"" },
                    { "Excel 23", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2854), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540112", null, "Excel 23", 20, 128, "", "\"Le Vieil Homme et la Mer\"" },
                    { "Excel 24", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2858), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540113", null, "Excel 24", 21, 320, "", "\"Le Journal de Bridget Jones\"" },
                    { "Excel 25", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2861), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540114", null, "Excel 25", 1, 416, "", "\"Le Meilleur des Mondes\"" },
                    { "Excel 26", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2865), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540115", null, "Excel 26", 15, 192, "", "\"L'Alchimiste\"" },
                    { "Excel 27", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2868), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540116", null, "Excel 27", 4, 384, "", "\"Le Portrait de Dorian Gray\"" },
                    { "Excel 28", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2874), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540118", null, "Excel 28", 6, 1312, "", "\"Le Comte de Monte-Cristo\"" },
                    { "Excel 29", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2878), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540119", null, "Excel 29", 20, 320, "", "\"Le Hobbit\"" },
                    { "Excel 3", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2779), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001195", null, "Excel 3", 3, 328, "", "\"1984\"" },
                    { "Excel 30", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2890), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540120", null, "Excel 30", 21, 704, "", "\"Les Trois Mousquetaires\"" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "Excel 31", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2906), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540121", null, "Excel 31", 2, 368, "", "\"Les Cerfs-volants de Kaboul\"" },
                    { "Excel 32", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2941), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540122", null, "Excel 32", 0, 224, "", "\"Le Grand Meaulnes\"" },
                    { "Excel 33", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2945), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540123", null, "Excel 33", 10, 304, "", "\"Le Journal de Kurt Cobain\"" },
                    { "Excel 34", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2950), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "978-2253004229", null, "Excel 34", 0, 288, "", "\"Les Fleurs du Mal\"" },
                    { "Excel 35", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2954), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "978-2070367980", null, "Excel 35", 30, 128, "", "\"Le Parti pris des choses\"" },
                    { "Excel 36", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2958), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782844140586", null, "Excel 36", 2, 288, "", "Les Contes de Grimm" },
                    { "Excel 37", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2962), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782844140589", null, "Excel 37", 12, 192, "", "Contes de Perrault" },
                    { "Excel 38", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2966), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782844140590", null, "Excel 38", 13, 384, "", "Les Contes d'Andersen" },
                    { "Excel 39", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2970), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782844140591", null, "Excel 39", 50, 832, "", "Contes des Mille et Une Nuits" },
                    { "Excel 4", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2782), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001196", null, "Excel 4", 60, 576, "", "\"Le Seigneur des Anneaux : La Communauté de l'Anneau\"" },
                    { "Excel 40", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2974), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782844140592", null, "Excel 40", 21, 160, "", "Contes de la Rue Broca" },
                    { "Excel 42", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2978), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782844140594", null, "Excel 42", 3, 400, "", "\"Pédagogie positive\"" },
                    { "Excel 43", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2982), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782844140595", null, "Excel 43", 23, 160, "", "\"L'École du Colibri\"" },
                    { "Excel 44", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2986), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782844140596", null, "Excel 44", 2, 288, "", "\"Apprendre autrement avec la pédagogie positive\"" },
                    { "Excel 45", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(3023), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782844140597", null, "Excel 45", 150, 320, "", "\"Le guide de survie enseignant suppléant\"" },
                    { "Excel 46", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(3027), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782844140598", null, "Excel 46", 3, 192, "", "\"La pédagogie Montessori à la maison\"" },
                    { "Excel 48", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(3031), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782012101320", null, "Excel 48", 20, 48, "", "\"Astérix le Gaulois\"" },
                    { "Excel 49", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(3035), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001193", null, "Excel 49", 12, 62, "", "\"Tintin au Tibet\"" },
                    { "Excel 5", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2785), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001197", null, "Excel 5", 3, 592, "", "\"Le Nom de la Rose\"" },
                    { "Excel 50", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(3040), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782070540102", null, "Excel 50", 2, 296, "", "\"Maus\"" },
                    { "Excel 51", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(3044), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782844140587", null, "Excel 51", 6, 352, "", "\"Persepolis\"" },
                    { "Excel 52", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(3048), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "978-2-8094-3960-2", null, "Excel 52", 8, 416, "", "\"Watchmen\"" },
                    { "Excel 6", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2788), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001198", null, "Excel 6", 5, 384, "", "\"Orgueil et Préjugés\"" },
                    { "Excel 7", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2791), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001199", null, "Excel 7", 10, 316, "", "\"L'Écume des Jours\"" },
                    { "Excel 8", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2794), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001200", null, "Excel 8", 12, 1232, "", "\"Les Misérables\"" },
                    { "Excel 9", null, "", new DateTime(2023, 10, 5, 11, 24, 8, 445, DateTimeKind.Local).AddTicks(2797), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "9782203001201", null, "Excel 9", 1, 576, "", "\"Le Rouge et le Noir\"" }
                });
