...
namespace VLISSIDES.Migrations
{
    ...
    [Migration("20231003142733_AjoutPanierMigration")]
    partial class AjoutPanierMigration
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "0",
                            ConcurrencyStamp = "0a6453f7-0f6e-4336-b8e5-abdb0a10ddaf",
                            Name = "Employe",
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "8a208fb9-c3dc-45fb-b0b2-966b6188d4f4",
                            Name = "Membre",
                        ...
                        {
                            Id = "2",
                            ConcurrencyStamp = "ce16bf14-2a8f-40de-b189-3a53d0e4a1c2",
                            Name = "Admin",
            ...
            modelBuilder.Entity("VLISSIDES.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3f2f0b6e-addd-4e57-bfbd-d4840dc263d0",
                            ...
                            Prenom = "Admin",
                            SecurityStamp = "2869b2ac-d8bc-477e-b8c6-457b6d6db4c1",
            ...
            modelBuilder.Entity("VLISSIDES.Models.Employe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AdressePrincipaleId = "",
                            ConcurrencyStamp = "93686af5-e3e6-478d-830a-7c572e243cef",
                            ...
                            PhoneNumberConfirmed = false,
                            Prenom = "Employe",
                            SecurityStamp = "fe9db49b-3684-4fbd-b173-11117bccf9ec",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("VLISSIDES.Models.Membre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AdressePrincipaleId = "",
                            ConcurrencyStamp = "81090d1c-eb43-4f96-9bb1-6ee88ac90889",
                            ...
                            PhoneNumberConfirmed = false,
                            Prenom = "Membre",
                            SecurityStamp = "0a37aaa1-def6-49f1-918d-e9deaf1b22ab",
                            TwoFactorEnabled = false,
                            UserName = "membre@membre.com",
                            DateAdhesion = new DateTime(2023, 10, 3, 10, 27, 31, 53, DateTimeKind.Local).AddTicks(7619),
                            NoMembre = "123456"
                        });
                });
            ...
            modelBuilder.Entity("VLISSIDES.Models.LivrePanier", b =>
                {
                    ...
                    b.HasOne("VLISSIDES.Models.Panier", "Panier")
                        .WithMany("LivresPanier")
            ...
            modelBuilder.Entity("VLISSIDES.Models.Panier", b =>
                {
                    b.HasOne("VLISSIDES.Models.ApplicationUser", "User")
                        .WithOne("Panier")
                        .HasForeignKey("VLISSIDES.Models.Panier", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
